                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        Toast.makeText(ProfileActivity.this, "Địa chỉ Email của bạn đã được thay đổi, mời bạn đăng nhập lại!", Toast.LENGTH_LONG).show();

                                    } else {
                                        Toast.makeText(ProfileActivity.this, "Cập nhật Email thất bại", Toast.LENGTH_LONG).show();
                                    }
                                }
                            });
                } else if (newEmail.getText().toString().trim().equals("")) {
                    newEmail.setError("Hãy nhập Email");
                }
            }
        });
