...
import vn.badatdp69.ungdungtracnghiem.adapter.ListQuestionAdapter;
import vn.badatdp69.ungdungtracnghiem.adapter.ViewQuestionAdapter;
import vn.badatdp69.ungdungtracnghiem.adapter.ViewQuestionMathAdapter;
...
import static vn.badatdp69.ungdungtracnghiem.fragment.HomeFragment.EXTRA_RAW_NAME;
...
public class QuizActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            Toast.makeText(QuizActivity.this, "Chúc bạn thi tốt!",Toast.LENGTH_SHORT).show();
        }
    }
...
//        saveScore();
    ...
    private void saveScoreFirebase(){
        Score score = new Score(
                rawName,
                numExam,
                mQuestions.size(),
                mQuestions.size() - sumUnAnswered,
                sumCorrect,
                scoreInScaleTen,
        ...
        if (mAuth.getUid() != null){
            mRef.child(mAuth.getUid()).child(rawName).child(String.valueOf(System.currentTimeMillis())).setValue(score);
        }
    }
